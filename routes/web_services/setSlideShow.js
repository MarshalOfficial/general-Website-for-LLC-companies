...
{	
	...
	([
		...
		function (callback)
		{
			...
			DBMain.setSlideshowInf(formVars.slideID, formVars.slideShowFormPage, formVars.slideShowFormLang, formVars.slideShowFormSN,
			alts,	formVars.slideShowFormTitle, formVars.slideShowFormUrl,
