            ...
            if (settings.animation === 1) {
                ...
                if (settings.multiPercentage !== 1) {
                    ...
                    if (settings.showPercent === 1) {
                        ...
                        myTimer
                            .find('.number')
                            .text(ToPersian(settings.target));
                        myTimer
                            .find('.percent')
                            .text('');
                    }
                    ...
                    if (settings.replacePercentageByText !== null) {
                        myTimer
                            .find('.number')
                            .text(ToPersian(settings.replacePercentageByText));
                        myTimer
                            .find('.percent')
                            .text('');
                    }
                    ...
                    circleContainer
                        ...
                        .append(
                            $('<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 194 186" class="circliful">' +
                                ...
                                '<tspan class="number">' + (settings.replacePercentageByText === null ? "۰" : settings.replacePercentageByText) + '</tspan>' +
