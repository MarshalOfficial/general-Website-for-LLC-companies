		...
		`<div class="row mt-3">
			<div class="col-md-3">
				<div class="card BoxShadow4">
					<img class="card-img-top img-fluid" src="${'/resources/' + key + '/' + res[2][key].image}">
					<div class="card-body">
...
function ArtResWithAddInfo(nodeId, nodeEnc, cbf)
{
	$.ajax
	({
		url: '/' + lang + '/panel/article/ArtResources',
		type: 'POST',
		data:
		{
			nodeId: nodeId,
...
function deleteResource(ev)
{
	...
	$.ajax
	({
		url: '/' + lang + '/panel/article/delResource',
		type: 'POST',
		data:
		{
			resId: resId,
...
{	
	...
	$.ajax
	({
		url: '/' + lang + '/panel/article/resources',
		type: 'POST',
		data: resData,
		success: function (res)
		{			
