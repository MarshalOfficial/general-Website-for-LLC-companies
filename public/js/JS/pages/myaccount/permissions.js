...
function GetAllClients(cbf)
{
	$.ajax
	({
		url: "/web_services/GetAllClients",
		type: 'POST',
...
function GetPermissionStatusClient(ID, cbf)
{
	$.ajax
	({
		url: "/web_services/GetPermissionStatus",
		type: 'POST',
		data:
		{
			ClientID: ID
...
function RemovePermission(userId, PermID)
{
	$.ajax
	({
		url: "/web_services/RemovePermission",
		type: 'POST',
		data:
		{
			ClientID: userId,
...
function AddPermission(userId, PermID)
{
	$.ajax
	({
		url: "/web_services/AddPermission",
		type: 'POST',
		data:
		{
			ClientID: userId,
...
function UpdateServiceRequestStepStatus(data)
{
	$.ajax
	({
		url: "/web_services/UpdateServiceRequestStepStatus",
		type: 'POST',
		data: data,
		success: function (res)
		{
