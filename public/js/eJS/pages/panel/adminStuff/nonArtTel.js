...
function nonArtsTelList(cbf)
{
	$.ajax
	({
		url: '/' + lang + '<%=consV.pages.panel.adminStuff.nonArtsTelList_WA%>',
		type: 'POST',
...
function nonArtTelDel(nodeId, cbf)
{
	...
	$.ajax
	({
		url: '/' + lang + '<%=consV.pages.panel.adminStuff.nonArtTelDel_WA%>',
		type: 'POST',
		data:
		{
			nodeId: nodeId
...
function nonArtTelAdd(nodeId, cbf)
{
	...
	$.ajax
	({
		url: '/' + lang + '<%=consV.pages.panel.adminStuff.nonArtTelAdd_WA%>',
		type: 'POST',
		data:
		{
			nodeId: nodeId
